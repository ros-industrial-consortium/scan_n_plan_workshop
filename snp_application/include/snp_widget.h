...
#include <snp_msgs/srv/generate_scan_trajectory_motion_plan.hpp>
...
private:
  ...
  rclcpp::Client<snp_msgs::srv::GenerateScanTrajectoryMotionPlan>::SharedPtr scan_traj_motion_planning_client_;
  ...
  void scan();
  void onScanGenerationDone(rclcpp::Client<snp_msgs::srv::GenerateScanTrajectoryMotionPlan>::SharedFuture future);
