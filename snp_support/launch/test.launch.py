...
def launch_setup(context, *args, **kwargs):
    ...
    rviz = Node(
        ...
        executable='rviz2',
        output='screen',
        arguments=['-d{}'.format(rviz_config)],
        parameters=[{
...
def generate_launch_description():
    return LaunchDescription([
        DeclareLaunchArgument('rviz_config', default_value=[os.path.join(get_package_share_directory('snp_support'), 'config', 'rviz_base_config.rviz')]),
